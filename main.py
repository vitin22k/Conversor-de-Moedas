...
titulo = customtkinter.CTkLabel(janela, text="Conversor de Moedas", font=("algerian", 25), text_color="#51D793")
texto_moeda_origem = customtkinter.CTkLabel(janela, text="Selecione a moeda de origem:", font= ("times new roman", 17))
texto_moeda_destino = customtkinter.CTkLabel(janela, text="Selecione a moeda de destino:", font= ("times new roman", 17))
...
campo_moeda_origem = customtkinter.CTkOptionMenu(janela, values=list(dic_conversoes_disponiveis.keys()), command=carregar_moedas_destino, font= ("times new roman", 17))
campo_moeda_destino = customtkinter.CTkOptionMenu(janela, values= ["Selecione uma moeda de origem"], font= ("times new roman", 17))
...
botao_converter = customtkinter.CTkButton(janela, text="Converter", command=converter_moeda, font=("times new roman", 17))
